...
export default function ConfirmDelete({ cancelAction, confirmAction }) {
    return (
        <div className="fixed inset-0 backdrop-blur-lg flex items-center justify-center p-4 z-10">
